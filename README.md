...
2. Copy files in [SDcard](SDcard/) to your SD card root if you havent already placed them on the SD Card by chosing the privously mentioned option to downloaded the [doorbell-customize-main.zip](https://github.com/cmdwhoami/doorbell-customize/archive/refs/heads/main.zip). 
